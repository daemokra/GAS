function newqiita() {
    ...
    var spreadSheet = SpreadsheetApp.openByUrl('https://docs.google.com/spreadsheets/d/1Se3x1ihv6m7Nim08Gim7mwmvvxe4SBnErf3fDCzGgFA/edit#gid=1665347682');
    ...
    // 前回値
    //var pre_view = sheet.getRange()
    sheet.getRange('C2:C10').copyTo(sheet.getRange('F2:F10'));
